...
basic_upgrade = (1, "Basic Upgrade", "A basic upgrade modifies an ore property by either addition, subtraction, multiplication, division, or modulo", "ore.forge.Strategies.UpgradeStrategies.BasicUpgrade")

bundled_upg = (2, "Bundled Upgrade", "Select to bundle up different types of upgrades. EX: you want an upgrader that multiplies ore value and substracts ore Temperature.", "ore.forge.Strategies.UpgradeStrategies.BundledUPG")
...
influenced_upg = (4, "Influenced Upgrade", "Modifier is influenced/determined by another factor.", "ore.forge.Strategies.UpgradeStrategies.InfluencedUPG")

resetter_upg = (5, "Resetter Upgrade", "Resets the upgrade tags of ore. Make sure to tag or as resetter if you want it to be balanced!", "ore.forge.Strategies.UpgradeStrategies.ResetterUPG")

apply_effect_upg = (6, "Apply Effect", "Applies an effect to ore.", "ore.forge.Strategies.UpgradeStrategies.ApplyEffectUPG")
...
values_of_influence = [value, upgrade_count, temperature, multiore, active_ore, placed_items, special_points, wallet, prestige_level]
